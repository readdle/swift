...
function(swift_windows_add_target_flags_if_needed target)
  if(NOT CMAKE_SYSTEM_NAME STREQUAL CMAKE_HOST_SYSTEM_NAME OR NOT CMAKE_SYSTEM_PROCESSOR STREQUAL CMAKE_HOST_SYSTEM_PROCESSOR OR CMAKE_C_COMPILER_ID MATCHES "Clang")
    target_compile_options(${target} PRIVATE "--target=${LLVM_DEFAULT_TARGET_TRIPLE}")
  endif()
endfunction()
...
macro(swift_swap_compiler_if_needed target)
  if(NOT CMAKE_C_COMPILER_ID MATCHES Clang)
    ...
    if(DEFINED CLANG_LOCATION)
      ...
      message(SEND_ERROR "${target} requires a clang based compiler. Please set CLANG_LOCATION.")
    endif()
  endif()
endmacro()
